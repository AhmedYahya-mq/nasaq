 ...
 * @route '/hidden/door/zone/master/email/verify'
 */
...
notice.definition = {
    methods: ["get","head"],
    url: '/hidden/door/zone/master/email/verify',
 ...
 * @route '/hidden/door/zone/master/email/verify/{id}/{hash}'
 */
...
verify.definition = {
    methods: ["get","head"],
    url: '/hidden/door/zone/master/email/verify/{id}/{hash}',
} satisfies RouteDefinition<["get","head"]>
 ...
 * @route '/hidden/door/zone/master/email/verification-notification'
 */
...
send.definition = {
    methods: ["post"],
    url: '/hidden/door/zone/master/email/verification-notification',
