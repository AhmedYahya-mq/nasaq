<svg class="{{ $class }}" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
    ...
    <g id="SVGRepo_iconCarrier">
        ...
        <path class="a" d="M14.98,41.8753a20.4839,20.4839,0,1,1,18.21-.0832"></path>
        <path class="a" d="M31.8164,38.6064,29.8255,42.97,34.0715,45"></path>
        <circle class="a" cx="25.3111" cy="12.1986" r="2.2096"></circle>
        <path class="a"
