...
<div x-data="{ open: false }" class="{{ $class }}">
    ...
    <div @click="open = !open"
        ...
        <svg :class="{'rotate-180': open}" xmlns="http://www.w3.org/2000/svg"
             class="h-5 w-5 transform transition-transform duration-[500ms]"
    ...
    <!-- المحتوى -->
    <div x-show="open"
         x-transition:enter="transition-all ease-in origin-top duration-[500ms]"
         x-transition:enter-start="max-h-0"
         x-transition:enter-end=" max-h-screen"
         x-transition:leave="transition-all ease-out origin-top duration-[500ms]"
