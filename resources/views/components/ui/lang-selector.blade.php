<x-ui.dropdown-menu
    ...
    <x-slot name="trigger">
        <button aria-label="تغيير اللغة"
            ...
            <picture>
                ...
                <img src="image source" class="img-fluid shadow-md size-full" alt="{{ __('messages.' . $locale) }}"
    ...
    <div class="flex flex-col gap-0.5">
        ...
        @php
            ...
            function safeLocaleRoute($routeName, $locale, $default = '/')
            {
                try {
        ...
        @foreach (['ar' => 'ar', 'en' => 'en'] as $key => $lang)
            <a href="{{ safeLocaleRoute($routeName, $key) }}"  @class([
