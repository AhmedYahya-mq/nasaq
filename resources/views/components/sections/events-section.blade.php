<section class="bg-background py-16">
    <div class="container mx-auto px-4">
        ...
        <div
            class="mb-16 relative bg-gradient-to-r from-primary/20 via-background to-background rounded-xl shadow-lg overflow-hidden">
        ...
        <div class="grid lg:grid-cols-2 gap-12 mb-20 items-start">
            ...
            <div>
                ...
                <div class="mt-6 text-left">
                    <a href="#"
                        class="inline-flex items-center gap-2 text-lg font-semibold text-primary hover:text-primary-dark transition-colors">
            ...
            <div class="bg-card p-6 rounded-xl shadow-md">
                <h2 class="text-2xl font-bold mb-6 text-foreground text-center lg:text-left">
