    ...
    <div class="container mx-auto">
        ...
        <div class="flex flex-col lg:flex-row w-full max-w-6xl mx-auto bg-card rounded-2xl shadow-2xl overflow-hidden animate-card-enter border border-border/20">
            ...
            <div class="w-full lg:w-1/2 p-8 sm:p-12 bg-primary/20 flex flex-col justify-center">
                ...
                <form action="{{ $actionUrl }}" method="POST" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1  gap-6 ">
                        <x-forms.input-password name="password" id="password" :label="__('login.password')" :placeholder="__('login.password_placeholder')" required />
                    </div>
                     <div class="grid grid-cols-1  gap-6 ">
                        <a href="#" class="font-semibold text-primary hover:text-primary/80 transition-colors">{{ __('login.forgit_password') }}</a>
                    ...
                    <p class="text-center text-sm text-muted-foreground pt-4 animate-fade-in-down" >
                        ...
                        <a href="#" class="font-semibold text-primary hover:text-primary/80 transition-colors">{{ __('login.register_link') }}</a>
                    </p>
                </form>
            </div>
            ...
            <div class="hidden lg:flex w-1/2 items-center justify-center p-12   to-background bg-primary/10 ">
                <img src="{{ asset('images/login.svg') }}" alt="Register Illustration" class="w-full max-w-md animate-image-float">
            </div>
        </div>
    </div>
</section>
