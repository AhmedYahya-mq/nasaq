<div {{ $attributes->merge([
    ...
    <div class="relative z-10 p-6">
        ...
        <div class="flex items-start justify-between mb-4">
            <h3 class="text-2xl font-bold text-card-foreground leading-tight group-hover:text-primary transition-colors duration-300 pr-12">
                {{ $event->title }}
            </h3>
        </div>
        ...
        <div class="mb-6">
            ...
            <div class="flex items-center justify-between mb-2">
                <div class="flex items-center gap-3">
                    ...
                    <span class="text-lg font-bold text-card-foreground">{{ $registered }}</span>
                </div>
        ...
        <div class="mb-4">
            ...
            <div class="membership-list hidden mt-2 pl-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            ...
            <div class="flex items-center gap-3 p-3 bg-card rounded-xl shadow-sm border border-border md:col-span-2">
                ...
                <div class="flex-1">
                    ...
                    <div class="text-sm font-semibold text-card-foreground line-clamp-1">
                        {{ $event->address }}
                    </div>
                </div>
            </div>
        ...
        <!-- الوصف -->
        <div class="mb-6">
            <p class="text-muted-foreground leading-relaxed line-clamp-2 text-sm">
                {{ $event->description }}
            </p>
        </div>
