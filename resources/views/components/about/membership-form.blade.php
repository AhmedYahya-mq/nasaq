            ...
            <form action="" method="POST" enctype="multipart/form-data" class="p-8 md:p-10">
                <div class="space-y-10">
                    ...
                    <fieldset class="space-y-6">
                        ...
                        <x-forms.input name="full_name" :label="__('memberships.personal_info.full_name')" required />
                        <x-forms.input name="email" type="email" :label="__('memberships.personal_info.email')" required />
                        <x-forms.tel-input name="phone" :label="__('memberships.personal_info.phone')" placeholder="05xxxxxxxx" required />
                        <x-forms.input name="id_number" :label="__('memberships.personal_info.id_number')" required />
                    </fieldset>
                    ...
                    <fieldset class="space-y-6">
                        ...
                        <x-forms.input name="job_title" :label="__('memberships.professional_info.job_title')" required />
                        <x-forms.input name="workplace" :label="__('memberships.professional_info.workplace')" />
