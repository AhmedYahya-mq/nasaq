    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-5 gap-12">
            ...
            <div class="lg:col-span-2">
                <h3 class="text-2xl font-bold text-foreground mb-6">{{ __('about.contact_section.quick_links.title') }}
                </h3>
                <div class="space-y-4">
                    @foreach ($contactMethods as $method)
                        ...
                        <a href="{{ $config['link'] }}" target="_blank" rel="noopener noreferrer"
                            ...
                            <div
                                class="flex-shrink-0 w-12 h-12 rounded-lg {{ $method['bg_color'] }} text-white flex items-center justify-center transition-transform duration-300 group-hover:scale-110 group-hover:rotate-6">
                                {!! $method['icon'] !!}
                            </div>
                            <div class="ms-4">
