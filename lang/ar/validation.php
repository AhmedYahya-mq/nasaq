...
return [
    ...
    */
    ...
    'arabic_letters'       => 'يجب أن يحتوي :attribute على أحرف عربية ومسافات فقط.',
    'english_letters'      => 'يجب أن يحتوي :attribute على أحرف إنجليزية ومسافات فقط.',
    ...
    */
    ...
    'attributes' => [
        ...
        'membership_started_at' => 'تاريخ بدء العضوية',
        'membership_expires_at' => 'تاريخ انتهاء العضوية',
        'national_id' => 'رقم الهوية الوطنية',
        'current_employer' => 'جهة العمل الحالية',
        'scfhs_number' => 'رقم الهيئة السعودية للتخصصات الصحية',
        'status' => 'الحالة',
        'admin_notes' => 'ملاحظات المسؤول',
        'notes' => 'ملاحظة',
        'user_id' => 'المستخدم',
        'moyasar_id' => 'معرف موياسار',
        'payable_id' => 'المعرف المرتبط بالدفع',
        'payable_type' => 'نوع العنصر المرتبط بالدفع',
        'amount' => 'المبلغ',
        'currency' => 'العملة',
        'cc_number' => 'رقم البطاقة',
        'cc_exp_month' => 'شهر الانتهاء',
        'cc_exp_year' => 'سنة الانتهاء',
        'cc_type' => 'نوع البطاقة',
        'cvc' => 'CVC',
